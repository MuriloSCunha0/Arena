...
export const RegistrationLink: React.FC<RegistrationLinkProps> = ({ event }) => {
  ...
  // The registration link would be generated by the backend
  // For now, we'll create a example link with the event ID
  ...
  const toggleLinkStatus = () => {
    // In a real app, this would call an API to enable/disable the registration link
